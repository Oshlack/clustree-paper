...
the Reingold-Tilford tree layout or the Sugiyama layout, both available as part
...
of 0.1 between zero and one and then in steps of 0.5. Clustree was then used
to visualise the results using the tree layout.
...
The clustree package (RRID: SCR_016293) is available from CRAN
(https://CRAN.R-project.org/package=clustree) and is being developed on
GitHub at https://github.com/lazappi/clustree. The code and datasets used for
the analysis in this paper are available from
...
Seurat tutorial page (http://satijalab.org/seurat/pbmc3k_tutorial.html) or the
