...
language. It relies on the ggraph package [@Pedersen2018-ie], which is itself
built on the ggplot2 [@Wickham2010-zq] and tidygraph [@Pedersen2018-ly]
packages. Clustering trees are displayed using the Reingold-Tilford tree layout
or the Sugiyama layout, both available as part of the igraph package.
...
Briefly cells were filtered based on the number of genes they express and the
percentage of counts assigned to mitochondrial genes. The data was then
log-normalised and 1838 variable genes identified. Potential confounding
