...
save_plot(here("figures/simulations.png"), sim_panel, nrow = 6, ncol = 3,
          base_width = 8, base_height = 6)
save_plot(here("figures/simulations.pdf"), sim_panel, nrow = 6, ncol = 3,
          base_width = 8, base_height = 6)

include_graphics(here("figures/simulations.png"))
```
